    ...
    return (
        <div>
            ...
            <div className="max-w-xl mx-auto px-4 py-20">
                ...
                <h1 className="text-4xl font-bold text-center mb-1">OTP Verification</h1>
                <p className="text-md text-gray-600 text-center">Please enter the 6-digit code sent to your mail</p>

                {/* OTP Form */}
                <OtpForm length={6} onVerify={handleOtpSubmit} />

                <p className="mt-1 text-gray-600 text-center">
                    Didn&apos;t get a code? <span className="text-red-500 cursor-pointer">Click to resend</span>
                </p>
            </div>
        </div>
    );
